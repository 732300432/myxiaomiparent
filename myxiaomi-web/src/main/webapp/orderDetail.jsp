        ...
        <table cellpadding="0" cellspacing="0" align="center" width="100%"
                    ...
                    <table align="center" cellpadding="0" cellspacing="0" width="100%"
                        ...
                        <c:forEach items="${items}" var="item" varStatus="i">
                            <tr align="center">
                                <th>${i.count}</th>
                                <th>
                                    <img src="${pageContext.request.contextPath}/goodsImgs/${item.goods.picture}"
            ...
            <tr>
                <td align="right" colspan="4" style="margin-right: 40px;">
                    ...
                    &nbsp;&nbsp;
                        <c:if test="${orders[0].status eq 1 }">
                            <button type="button" onclick="pay('${orders[0].id}','${orders[0].money}')"
                                    class="btn btn-warning btn-sm">易付宝支付
                            </button>
                            &nbsp;&nbsp;
                            <button type="button" onclick="payWeiXin('${orders[0].id}','${orders[0].money}')"
