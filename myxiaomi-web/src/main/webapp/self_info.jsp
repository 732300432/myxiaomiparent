...
<script type="text/javascript">
	function deleteAddr(id){
		...
		if(res==true){
			window.location.href="${pageContext.request.contextPath}/addressservlet?method=deleteAddress&id="+id;
		}
	}
	function defaultAddr(id){
		var res = confirm("是否设为默认");
		if(res==true){
			window.location.href="${pageContext.request.contextPath}/addressservlet?method=updateDefaultAddress&id="+id;
    ...
    <div id="dingdanxiangqing_body_big">
     ...
     <div id="big_right" style="height: 500px;overflow: scroll;">
							...
							<div class="modal fade" tabindex="-1" role="dialog" id="myModal${address.id}">
							  <div class="modal-dialog" role="document">
							    <div class="modal-content">
									...
									<form action="${pageContext.request.contextPath}/addressservlet?method=updateAddress" method="post" class="form-horizontal">
		...
		<div class="container" style="width:960px;">
			...
			<form action="${pageContext.request.contextPath}/addressservlet?method=addAddress" method="post" class="form-horizontal">
				<div class="form-group">
				...
				<div class="text-left" style="color: red;text-indent: 2em">${msg}</div>
			</form>
	      </div>
       </div>
    </div>
